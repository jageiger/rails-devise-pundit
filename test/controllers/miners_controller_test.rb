...
class MinersControllerTest < ActionController::TestCase
  ...
  test "should create miner" do
    assert_difference('Miner.count') do
      post :create, miner: { ip: @miner.ip, name: @miner.name, pool_id: @miner.pool_id, state: @miner.state }
    end
  ...
  test "should update miner" do
    patch :update, id: @miner, miner: { ip: @miner.ip, name: @miner.name, pool_id: @miner.pool_id, state: @miner.state }
    assert_redirected_to miner_path(assigns(:miner))
  end
