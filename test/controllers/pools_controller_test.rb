...
class PoolsControllerTest < ActionController::TestCase
  ...
  test "should create pool" do
    assert_difference('Pool.count') do
      post :create, pool: { ip: @pool.ip, password: @pool.password, user_id: @pool.user_id, user_name: @pool.user_name }
    end
  ...
  test "should update pool" do
    patch :update, id: @pool, pool: { ip: @pool.ip, password: @pool.password, user_id: @pool.user_id, user_name: @pool.user_name }
    assert_redirected_to pool_path(assigns(:pool))
  end
